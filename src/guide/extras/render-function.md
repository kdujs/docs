...
That's right, this is a valid Kdu component! See [Functional Components](#functional-components) for more details on this syntax.
...
Custom directives can be applied to a knode using [`withDirectives`](/api/render-function.html#withdirectives):
